        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              role="dialog" aria-labelledby="accessibility-title" aria-describedby="accessibility-description"
            >
              {/* Header */}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h2 id="accessibility-title" className="text-2xl font-bold text-gray-900 flex items-center">
                      <Accessibility className="w-6 h-6 mr-3 text-blue-600" aria-hidden="true" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    ...
                    <button
                      ...
                      role="switch" aria-checked={settings.highContrast} aria-label="Alternar alto contraste"
                    >
                      <span
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {fontSizes.map((size) => (
                      <button
                        ...
                        className={`hc-surface p-4 rounded-xl border-2 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                      ...
                      <button
                        ...
                        role="switch" aria-checked={settings.focusVisible} aria-label="Alternar foco visível"
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                      ...
                      <button
                        ...
                        role="switch" aria-checked={settings.reducedMotion} aria-label="Alternar movimento reduzido"
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                      ...
                      <button
                        ...
                        role="switch" aria-checked={settings.soundEffects} aria-label="Alternar efeitos sonoros"
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
