...
const Layout: React.FC<LayoutProps> = ({ children }) => {
	...
	return (
		<div className="min-h-screen flex flex-col">
			...
			{/* Header */}
			<header className="bg-white shadow-lg border-b-4 border-blue-600 sticky top-0 z-40" role="banner">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex items-center justify-between h-20">
						...
						>
							<img src="https://i.imgur.com/cIviSuG.png" alt="Brasão da Prefeitura de Aracaju" className="h-12 w-12" />
							<div>
			...
			<footer className="bg-gray-900 text-white" role="contentinfo">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						...
						<div>
							<h3 className="text-lg font-semibold mb-4">Prefeitura de Aracaju</h3>
					...
					<div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
						<p>© 2025 Prefeitura Municipal de Aracaju. Todos os direitos reservados.</p>
						<p className="mt-2">
							<a
